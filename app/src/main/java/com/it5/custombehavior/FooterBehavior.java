...
public class FooterBehavior extends CoordinatorLayout.Behavior<LinearLayout> {
    ...
    private void hide(final View view) {
       final ViewPropertyAnimator animator = view.animate().translationY(view.getHeight()).setInterpolator(INTERPOLATOR).setDuration(200);
    ...
    private void show(final View view) {
        final ViewPropertyAnimator animator = view.animate().translationY(0).setInterpolator(INTERPOLATOR).setDuration(200);
        animator.setListener(new Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(Animator animator) {
